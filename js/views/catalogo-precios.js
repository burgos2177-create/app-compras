...
import { dateMx, num, num0, money } from '../util/format.js?v=20260711d';
import { exportCatalogoComparativaPdf, exportCatalogoComparativaXlsx, exportMaterialesOpusXlsx } from '../services/subcontrato-export.js?v=20260711d';
