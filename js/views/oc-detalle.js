...
import { dateMx, num, num0, money, ocFolio, reqFolio } from '../util/format.js?v=20260711o';
import { estadoOCBadge } from './oc.js?v=20260711o';
import { exportOcPdf, exportOcDoc, usoCfdiEfectivo } from '../services/oc-export.js?v=20260711o';
...
export async function renderOCDetalle({ params }) {
  ...
  const head = h('div', { class: 'row' }, [
    ...
    h('button', {
      class: 'btn primary',
      onClick: () => navigate(`/obras/${obraId}/cotizaciones/nueva?fromOc=${ocId}`),
      title: 'Crear una nueva cotización copiando materiales, conceptos y costos de esta OC (para agregar más y volver a emitir)'
    }, '🔁 Nueva cotización a partir de esta'),
