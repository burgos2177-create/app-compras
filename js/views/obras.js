import { h, toast } from '../util/dom.js?v=20260612';
import { renderShell } from './shell.js?v=20260612';
import { state, setState } from '../state/store.js?v=20260612';
import { listObrasForUser, listBuzon, filtrarBuzon } from '../services/db.js?v=20260612';
import { navigate } from '../state/router.js?v=20260612';
import { dateMx, num0 } from '../util/format.js?v=20260612';
