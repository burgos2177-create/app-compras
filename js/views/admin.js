...
import { state } from '../state/store.js?v=20260711i';
import { listUsersLegacy, listObrasLegacy } from '../services/db.js?v=20260711i';
import { createUser, updateUserRole, setUserAssignment } from '../services/auth.js?v=20260711i';
