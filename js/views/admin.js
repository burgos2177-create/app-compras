...
import { state } from '../state/store.js?v=20260711e';
import { listUsersLegacy, listObrasLegacy } from '../services/db.js?v=20260711e';
import { createUser, updateUserRole, setUserAssignment } from '../services/auth.js?v=20260711e';
