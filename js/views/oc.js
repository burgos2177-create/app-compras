...
import { getObraMetaLegacy, listOC, listBuzon, filtrarBuzon } from '../services/db.js?v=20260711h';
import { navigate } from '../state/router.js?v=20260711h';
import { dateMx, num0, money, ocFolio } from '../util/format.js?v=20260711h';
