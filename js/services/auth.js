...
import { auth, firebaseConfig } from './firebase.js?v=20260711l';
import { rread, rset, rupdate } from './db.js?v=20260711l';
...
export async function createUser({ email, password, displayName, role = 'comprador' }) {
